...
![1. 물리 메모리의 한계]({{ img_path }}/1. 물리 메모리의 한계.png)
...
![2.1. 스와핑]({{ img_path }}/2.1. 스와핑.png){: width='300'}
...
![2.3. 메모리에 대한 각 시스템들의 관계]({{ img_path }}/2.3. 메모리에 대한 각 시스템들의 관계.png)
...
![3.2. Swap area]({{ img_path }}/3.2. Swap area.png)
...
![3.4. 가상 메모리와 페이지 테이블]({{ img_path }}/3.4. 가상 메모리와 페이지 테이블.png)
...
![5.1. 예제-1]({{ img_path }}/5.1. 예제-1.png)

- 프로세스 실행
  - 프로세스 실행을 시작할 떄 첫 페이지를 메모리에 적재
 
![5.1. 예제-2]({{ img_path }}/5.1. 예제-2.png)

- 페이지 폴트를 통해 실행파일로부터 페이지들 적재

![5.1. 예제-3]({{ img_path }}/5.1. 예제-3.png)

- 메모리가 부족하면 스왑-아웃/스왑-인

![5.1. 예제-4]({{ img_path }}/5.1. 예제-4.png)

- 스왑-아웃된 페이지 100의 스왑-인 후 n++ 실행

![5.1. 예제-5]({{ img_path }}/5.1. 예제-5.png)
...
![5.2. Page fault 해결]({{ img_path }}/5.2. Page fault 해결.png)
...
![6. fork() 다시보기]({{ img_path }}/6. fork() 다시보기.png)
...
![6. fork() 다시보기-2]({{ img_path }}/6. fork() 다시보기-2.png){: width=550'}
...
![6.1. COW-1]({{ img_path }}/6.1. COW-1.png){: width='300'}
